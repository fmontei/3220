...
add wave -noupdate -radix decimal /lg_highlevel/Decode0/I_IR
add wave -noupdate -radix decimal /lg_highlevel/Decode0/O_IR
...
WaveRestoreCursors {{Cursor 1} {2601 ps} 0}
...
update
WaveRestoreZoom {2596 ps} {3443 ps}
