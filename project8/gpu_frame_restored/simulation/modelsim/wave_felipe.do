...
add wave -noupdate -radix binary /lg_highlevel/Execute0/CCValue
...
add wave -noupdate -radix hexadecimal /lg_highlevel/Fetch0/O_IR
add wave -noupdate -radix hexadecimal /lg_highlevel/Decode0/I_IR
add wave -noupdate -radix hexadecimal /lg_highlevel/Execute0/I_IR
...
WaveRestoreCursors {{Cursor 1} {1400 ps} 0}
...
update
WaveRestoreZoom {1092 ps} {1939 ps}
