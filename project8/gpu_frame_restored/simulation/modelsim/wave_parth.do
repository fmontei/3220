...
add wave -noupdate /lg_highlevel/Decode0/VRF
add wave -noupdate -radix decimal /lg_highlevel/Memory0/DataMem
add wave -noupdate -radix hexadecimal /lg_highlevel/Memory0/HexOut
...
add wave -noupdate /lg_highlevel/Writeback0/O_WriteBackVRegIdx
add wave -noupdate /lg_highlevel/Writeback0/O_VecDestValue
add wave -noupdate /lg_highlevel/Decode0/O_DestVRegIdx
add wave -noupdate /lg_highlevel/Execute0/O_DestVRegIdx
add wave -noupdate -radix hexadecimal /lg_highlevel/Execute0/O_DestValue
add wave -noupdate /lg_highlevel/Execute0/O_VecDestValue
add wave -noupdate /lg_highlevel/Execute0/O_VRegWEn
add wave -noupdate /lg_highlevel/Memory0/O_VRegWEn
add wave -noupdate /lg_highlevel/Memory0/O_DestVRegIdx
add wave -noupdate /lg_highlevel/Memory0/O_DestValue
add wave -noupdate /lg_highlevel/Writeback0/O_VRegWEn
add wave -noupdate /lg_highlevel/Writeback0/O_WriteBackData
add wave -noupdate /lg_highlevel/Writeback0/O_WriteBackVRegIdx
add wave -noupdate /lg_highlevel/Writeback0/O_VIdxIdx
add wave -noupdate /lg_highlevel/Writeback0/I_DestValue
...
WaveRestoreCursors {{Cursor 1} {887 ps} 0}
